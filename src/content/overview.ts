  ...
  columns: [
    {
      ...
      paragraphs: [
        ...
        "Eager to explore modern Deep Learning architectures and their applications in demanding environments, while contributing to publication-oriented research, I chose to multiply my laboratory experiences, notably in the medical and biomedical fields. This allowed me to quickly understand, adapt and implement recent models from specialized AI conferences and journals.",
        "In parallel, I code a lot in my free time: embedded software in C/C++, Python tools, Java projects around Minecraft including network communications, APIs and server tools. I also enjoy doing some web development from time to time, as you can see with this very website.",
      ],
    },
    {
      id: "research",
